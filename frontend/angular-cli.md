...
- ng new <project name> will create new project
    ...
    - if you move a project created outside into an existing repo, you'll have to elete the new repo, etc.
-ng serve will start your server and run the project
    ...
    - if you have "compilation" errors, Angular will throw those erros in the console and the browser
    - you can also add flags here for which environemnt to run (dev/prod, etc.)
